...
write_fitted_parameters <- function(model.path, parhistory) {
	...
	#Copy the original paramater input structures to act as a template for the new data
	...
	preference_matrix_input_NEW$birdmam[which(rownames(preference_matrix_input_NEW)=="omnivzoo")] <- parhistory$PREF_herb_bird[ROW_TO_USE]
	preference_matrix_input_NEW$birdmam[which(rownames(preference_matrix_input_NEW)=="carnzoo")] <- parhistory$PREF_carn_bird[ROW_TO_USE]
	preference_matrix_input_NEW$birdmam[which(rownames(preference_matrix_input_NEW)=="benths")] <- parhistory$PREF_benths_bird[ROW_TO_USE]
	preference_matrix_input_NEW$birdmam[which(rownames(preference_matrix_input_NEW)=="benthc")] <- parhistory$PREF_benthc_bird[ROW_TO_USE]

	preference_matrix_input_NEW$birdmam[which(rownames(preference_matrix_input_NEW)=="fishp")] <- parhistory$PREF_fishp_bird[ROW_TO_USE]
	preference_matrix_input_NEW$birdmam[which(rownames(preference_matrix_input_NEW)=="fishm")] <- parhistory$PREF_fishm_bird[ROW_TO_USE]
	preference_matrix_input_NEW$birdmam[which(rownames(preference_matrix_input_NEW)=="fishd")] <- parhistory$PREF_fishd_bird[ROW_TO_USE]
	preference_matrix_input_NEW$birdmam[which(rownames(preference_matrix_input_NEW)=="discards")] <- parhistory$PREF_disc_bird[ROW_TO_USE]
	preference_matrix_input_NEW$birdmam[which(rownames(preference_matrix_input_NEW)=="corpses")] <- parhistory$PREF_corp_bird[ROW_TO_USE]


	#Then we set the rate parameters for each predator at the reference temperature

	uptake_mort_input_NEW$umax[which(uptake_mort_input_NEW$consumer=="phyt_s")] <- parhistory$u_phyt[ROW_TO_USE]
	uptake_mort_input_NEW$umax[which(uptake_mort_input_NEW$consumer=="omnivzoo")] <- parhistory$u_herb[ROW_TO_USE]
	uptake_mort_input_NEW$umax[which(uptake_mort_input_NEW$consumer=="carnzoo")] <- parhistory$u_carn[ROW_TO_USE]
	uptake_mort_input_NEW$umax[which(uptake_mort_input_NEW$consumer=="fishplar")] <- parhistory$u_fishplar[ROW_TO_USE]
	uptake_mort_input_NEW$umax[which(uptake_mort_input_NEW$consumer=="fishp")] <- parhistory$u_fishp[ROW_TO_USE]
	uptake_mort_input_NEW$umax[which(uptake_mort_input_NEW$consumer=="fishm")] <- parhistory$u_fishm[ROW_TO_USE]
	uptake_mort_input_NEW$umax[which(uptake_mort_input_NEW$consumer=="fishdlar")] <- parhistory$u_fishdlar[ROW_TO_USE]
	uptake_mort_input_NEW$umax[which(uptake_mort_input_NEW$consumer=="fishd")] <- parhistory$u_fishd[ROW_TO_USE]
	uptake_mort_input_NEW$umax[which(uptake_mort_input_NEW$consumer=="benthslar")] <- parhistory$u_benthslar[ROW_TO_USE]
	uptake_mort_input_NEW$umax[which(uptake_mort_input_NEW$consumer=="benthclar")] <- parhistory$u_benthclar[ROW_TO_USE]
	uptake_mort_input_NEW$umax[which(uptake_mort_input_NEW$consumer=="benths")] <- parhistory$u_benths[ROW_TO_USE]
	uptake_mort_input_NEW$umax[which(uptake_mort_input_NEW$consumer=="benthc")] <- parhistory$u_benthc[ROW_TO_USE]
	uptake_mort_input_NEW$umax[which(uptake_mort_input_NEW$consumer=="birdmam")] <- parhistory$u_bird[ROW_TO_USE]

	uptake_mort_input_NEW$hsat[which(uptake_mort_input_NEW$consumer=="phyt_s")] <- parhistory$h_phyt[ROW_TO_USE]
	uptake_mort_input_NEW$hsat[which(uptake_mort_input_NEW$consumer=="omnivzoo")] <- parhistory$h_herb[ROW_TO_USE]
	uptake_mort_input_NEW$hsat[which(uptake_mort_input_NEW$consumer=="carnzoo")] <- parhistory$h_carn[ROW_TO_USE]
	uptake_mort_input_NEW$hsat[which(uptake_mort_input_NEW$consumer=="fishplar")] <- parhistory$h_fishplar[ROW_TO_USE]
	uptake_mort_input_NEW$hsat[which(uptake_mort_input_NEW$consumer=="fishp")] <- parhistory$h_fishp[ROW_TO_USE]
	uptake_mort_input_NEW$hsat[which(uptake_mort_input_NEW$consumer=="fishm")] <- parhistory$h_fishm[ROW_TO_USE]
	uptake_mort_input_NEW$hsat[which(uptake_mort_input_NEW$consumer=="fishdlar")] <- parhistory$h_fishdlar[ROW_TO_USE]
	uptake_mort_input_NEW$hsat[which(uptake_mort_input_NEW$consumer=="fishd")] <- parhistory$h_fishd[ROW_TO_USE]
	uptake_mort_input_NEW$hsat[which(uptake_mort_input_NEW$consumer=="benthslar")] <- parhistory$h_benthslar[ROW_TO_USE]
	uptake_mort_input_NEW$hsat[which(uptake_mort_input_NEW$consumer=="benthclar")] <- parhistory$h_benthclar[ROW_TO_USE]
	uptake_mort_input_NEW$hsat[which(uptake_mort_input_NEW$consumer=="benths")] <- parhistory$h_benths[ROW_TO_USE]
	uptake_mort_input_NEW$hsat[which(uptake_mort_input_NEW$consumer=="benthc")] <- parhistory$h_benthc[ROW_TO_USE]
	uptake_mort_input_NEW$hsat[which(uptake_mort_input_NEW$consumer=="birdmam")] <- parhistory$h_bird[ROW_TO_USE]

	uptake_mort_input_NEW$BdeApar[which(uptake_mort_input_NEW$consumer=="birdmam")] <- parhistory$bda_par_bird[ROW_TO_USE]
	...
	uptake_mort_input_NEW$ddmort[which(uptake_mort_input_NEW$consumer=="birdmam")] <- parhistory$xxbird[ROW_TO_USE]
	...
	microbiology_input_NEW$Value[17] <- parhistory$xdsink_s[ROW_TO_USE]
	microbiology_input_NEW$Value[18] <- parhistory$xdsink_d[ROW_TO_USE]

	#Fitting parameter fopr demersal discard rate - expect this to be about 1.0
	microbiology_input_NEW$Value[19] <- parhistory$xdfdp[ROW_TO_USE]
	...
	uptake_mort_input_NEW$migration_coef[which(uptake_mort_input_NEW$consumer=="birdmam")] <- parhistory$xbird_migcoef[ROW_TO_USE]
	...
	uptake_mort_input_NEW$max_exploitable_f[which(uptake_mort_input_NEW$consumer=="birdmam")] <- parhistory$xmax_exploitable_f_BM[ROW_TO_USE]
	...
	# ZZ write.table to results/ ?? what is oudir exactly (testbed subdir) - certainly not back to Model/Parameters dir!
