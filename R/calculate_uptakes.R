...
calculate_uptakes <- function(fitted.parms) {
	...
	PREF_NIT_kelp		= el(fitted.parms, "PREF_NIT_kelp")
	PREF_AMM_kelp		= el(fitted.parms, "PREF_AMM_kelp")
	PREF_NIT_phyt		= el(fitted.parms, "PREF_NIT_phyt")
	PREF_AMM_phyt		= el(fitted.parms, "PREF_AMM_phyt")
	PREF_phyt_herb		= el(fitted.parms, "PREF_phyt_herb")
	PREF_det_herb		= el(fitted.parms, "PREF_det_herb")
	PREF_benthslar_herb	= el(fitted.parms, "PREF_benthslar_herb")
	PREF_benthclar_herb	= el(fitted.parms, "PREF_benthclar_herb")
	PREF_herb_carn		= el(fitted.parms, "PREF_herb_carn")
	PREF_benthslar_carn	= el(fitted.parms, "PREF_benthslar_carn")
	PREF_benthclar_carn	= el(fitted.parms, "PREF_benthclar_carn")	# ZZ meh - are these not supposed to be the perturbed ones?
	PREF_fishplar_carn	= el(fitted.parms, "PREF_fishplar_carn")
	PREF_fishdlar_carn	= el(fitted.parms, "PREF_fishdlar_carn")
	PREF_herb_fishplar	= el(fitted.parms, "PREF_herb_fishplar")
	PREF_benthslar_fishplar	= el(fitted.parms, "PREF_benthslar_fishplar")
	PREF_benthclar_fishplar	= el(fitted.parms, "PREF_benthclar_fishplar")
	PREF_herb_fishp		= el(fitted.parms, "PREF_herb_fishp")
	PREF_carn_fishp		= el(fitted.parms, "PREF_carn_fishp")
	PREF_benthslar_fishp	= el(fitted.parms, "PREF_benthslar_fishp")
	PREF_benthclar_fishp	= el(fitted.parms, "PREF_benthclar_fishp")
	PREF_fishdlar_fishp	= el(fitted.parms, "PREF_fishdlar_fishp")
	PREF_fishplar_fishp	= el(fitted.parms, "PREF_fishplar_fishp")
	PREF_herb_fishm		= el(fitted.parms, "PREF_herb_fishm")
	PREF_carn_fishm		= el(fitted.parms, "PREF_carn_fishm")
	PREF_benthslar_fishm	= el(fitted.parms, "PREF_benthslar_fishm")
	PREF_benthclar_fishm	= el(fitted.parms, "PREF_benthclar_fishm")
	PREF_fishdlar_fishm	= el(fitted.parms, "PREF_fishdlar_fishm")
	PREF_fishplar_fishm	= el(fitted.parms, "PREF_fishplar_fishm")
	PREF_herb_fishdlar	= el(fitted.parms, "PREF_herb_fishdlar")
	PREF_benthslar_fishdlar	= el(fitted.parms, "PREF_benthslar_fishdlar")
	PREF_benthclar_fishdlar	= el(fitted.parms, "PREF_benthclar_fishdlar")
	PREF_carn_fishd		= el(fitted.parms, "PREF_carn_fishd")
	PREF_benths_fishd	= el(fitted.parms, "PREF_benths_fishd")
	PREF_benthc_fishd	= el(fitted.parms, "PREF_benthc_fishd")
	PREF_fishplar_fishd	= el(fitted.parms, "PREF_fishplar_fishd")
	PREF_fishdlar_fishd	= el(fitted.parms, "PREF_fishdlar_fishd")
	PREF_fishp_fishd	= el(fitted.parms, "PREF_fishp_fishd")
	PREF_fishm_fishd	= el(fitted.parms, "PREF_fishm_fishd")
	PREF_fishd_fishd	= el(fitted.parms, "PREF_fishd_fishd")
	PREF_disc_fishd		= el(fitted.parms, "PREF_disc_fishd")
	PREF_corp_fishd		= el(fitted.parms, "PREF_corp_fishd")
	PREF_phyt_benthslar	= el(fitted.parms, "PREF_phyt_benthslar")
	PREF_det_benthslar	= el(fitted.parms, "PREF_det_benthslar")
	PREF_phyt_benthclar	= el(fitted.parms, "PREF_phyt_benthclar")
	PREF_det_benthclar	= el(fitted.parms, "PREF_det_benthclar")
	PREF_phyt_benths	= el(fitted.parms, "PREF_phyt_benths")
	PREF_det_benths		= el(fitted.parms, "PREF_det_benths")
	PREF_sed_benths		= el(fitted.parms, "PREF_sed_benths")
	PREF_kelp_benthc	= el(fitted.parms, "PREF_kelp_benthc")
	PREF_kelpdebris_benthc	= el(fitted.parms, "PREF_kelpdebris_benthc")
	PREF_benths_benthc	= el(fitted.parms, "PREF_benths_benthc")
	PREF_corp_benthc	= el(fitted.parms, "PREF_corp_benthc")
	PREF_carn_bird		= el(fitted.parms, "PREF_carn_bird")
	PREF_benths_bird	= el(fitted.parms, "PREF_benths_bird")
	PREF_benthc_bird	= el(fitted.parms, "PREF_benthc_bird")
	PREF_fishp_bird		= el(fitted.parms, "PREF_fishp_bird")
	PREF_fishm_bird		= el(fitted.parms, "PREF_fishm_bird")
	PREF_fishd_bird		= el(fitted.parms, "PREF_fishd_bird")
	PREF_disc_bird		= el(fitted.parms, "PREF_disc_bird")
	PREF_corp_bird		= el(fitted.parms, "PREF_corp_bird")
	PREF_carn_seal		= el(fitted.parms, "PREF_carn_seal")
	PREF_benths_seal	= el(fitted.parms, "PREF_benths_seal")
	PREF_benthc_seal	= el(fitted.parms, "PREF_benthc_seal")
	PREF_fishp_seal		= el(fitted.parms, "PREF_fishp_seal")
	PREF_fishm_seal		= el(fitted.parms, "PREF_fishm_seal")
	PREF_fishd_seal		= el(fitted.parms, "PREF_fishd_seal")
	PREF_bird_seal		= el(fitted.parms, "PREF_bird_seal")
	PREF_disc_seal		= el(fitted.parms, "PREF_disc_seal")
	PREF_corp_seal		= el(fitted.parms, "PREF_corp_seal")
	PREF_herb_ceta		= el(fitted.parms, "PREF_herb_ceta")
	PREF_carn_ceta		= el(fitted.parms, "PREF_carn_ceta")
	PREF_benths_ceta	= el(fitted.parms, "PREF_benths_ceta")
	PREF_benthc_ceta	= el(fitted.parms, "PREF_benthc_ceta")
	PREF_fishp_ceta		= el(fitted.parms, "PREF_fishp_ceta")
	PREF_fishm_ceta		= el(fitted.parms, "PREF_fishm_ceta")
	PREF_fishd_ceta		= el(fitted.parms, "PREF_fishd_ceta")
	PREF_bird_ceta		= el(fitted.parms, "PREF_bird_ceta")
	PREF_seal_ceta		= el(fitted.parms, "PREF_seal_ceta")
	PREF_disc_ceta		= el(fitted.parms, "PREF_disc_ceta")

	#Then we set the rate parameters for each predator at the reference temperature

	u_kelp			= el(fitted.parms, "u_kelp")
	u_phyt			= el(fitted.parms, "u_phyt")
	u_herb			= el(fitted.parms, "u_herb")
	u_carn			= el(fitted.parms, "u_carn")
	u_fishplar		= el(fitted.parms, "u_fishplar")
	u_fishp			= el(fitted.parms, "u_fishp")
	u_fishm			= el(fitted.parms, "u_fishm")
	u_fishdlar		= el(fitted.parms, "u_fishdlar")
	u_fishd			= el(fitted.parms, "u_fishd")
	u_benthslar		= el(fitted.parms, "u_benthslar")
	u_benthclar		= el(fitted.parms, "u_benthclar")
	u_benths		= el(fitted.parms, "u_benths")
	u_benthc		= el(fitted.parms, "u_benthc")
	u_bird			= el(fitted.parms, "u_bird")
	u_seal			= el(fitted.parms, "u_seal")
	u_ceta			= el(fitted.parms, "u_ceta")

	h_kelp			= el(fitted.parms, "h_kelp")
	h_phyt			= el(fitted.parms, "h_phyt")
	h_herb			= el(fitted.parms, "h_herb")
	h_carn			= el(fitted.parms, "h_carn")
	h_fishplar		= el(fitted.parms, "h_fishplar")
	h_fishp			= el(fitted.parms, "h_fishp")
	h_fishm			= el(fitted.parms, "h_fishm")
	h_fishdlar		= el(fitted.parms, "h_fishdlar")
	h_fishd			= el(fitted.parms, "h_fishd")
	h_benthslar		= el(fitted.parms, "h_benthslar")
	h_benthclar		= el(fitted.parms, "h_benthclar")
	h_benths		= el(fitted.parms, "h_benths")
	h_benthc		= el(fitted.parms, "h_benthc")
	h_bird			= el(fitted.parms, "h_bird")
	h_seal			= el(fitted.parms, "h_seal")
	h_ceta			= el(fitted.parms, "h_ceta")

	bda_par_bird		= el(fitted.parms, "bda_par_bird")
	bda_par_seal		= el(fitted.parms, "bda_par_seal")
	bda_par_ceta		= el(fitted.parms, "bda_par_ceta")
