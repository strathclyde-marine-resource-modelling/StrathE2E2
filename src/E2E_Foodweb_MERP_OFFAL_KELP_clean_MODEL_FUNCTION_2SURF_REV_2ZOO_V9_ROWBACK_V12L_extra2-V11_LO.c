...
init_static()
{
	Rprintf("Init. globals...\n");
#define INITVAL	999.0
 volume_so=INITVAL;
 volume_si=INITVAL;
 volume_d=INITVAL;
 driverhdtemp=INITVAL;
 driverwcotemp=INITVAL;
 driversbdtemp=INITVAL;
 driverssdtemp=INITVAL;
 driverzodtemp=INITVAL;
 driverbslotemp=INITVAL;
 driverbclotemp=INITVAL;
 kvertattn_o=INITVAL;
 kvertattn_i=INITVAL;
 phyt_propsl_o=INITVAL;
 phyt_propsl_i=INITVAL;
 kelp_propsl_i=INITVAL;
 phyt_S_layer_light_o=INITVAL;
 phyt_S_layer_light_i=INITVAL;
 kelp_S_layer_light_i=INITVAL;
 inshore_plough_daily=INITVAL;
 offshore_plough_daily=INITVAL;
 xs_o=INITVAL;
 xs_i=INITVAL;
 xd=INITVAL;
 xherb_o=INITVAL;
 ...
 xcarn_o=INITVAL;
 xcarn_i=INITVAL;
 xbenthslar_o=INITVAL;
 xbenthslar_i=INITVAL;
 xbenthclar_o=INITVAL;
 xbenthclar_i=INITVAL;
 xbenths_o=INITVAL;
 xbenths_i=INITVAL;
 xbenthc_o=INITVAL;
 xbenthc_i=INITVAL;
 ...
 xceta_i=INITVAL;
 wave_kelp_i=INITVAL;
 selfshade_kelp_i=INITVAL;
 exudeC_kelpt_i=INITVAL;
 uC_kelp_i=INITVAL;
 exC_kelp_i=INITVAL;
 uNIT_kelp_i=INITVAL;
 uAMM_kelp_i=INITVAL;
 ...
 uNIT_phyt_i=INITVAL;
 uAMM_phyt_i=INITVAL;
 ubenthslar_o_herb=INITVAL;
 ubenthclar_o_herb=INITVAL;
 udet_so_herb=INITVAL;
 udet_si_herb=INITVAL;
 udet_d_herb=INITVAL;
 uphyt_so_herb=INITVAL;
 uphyt_si_herb=INITVAL;
 uphyt_d_herb=INITVAL;
 ubenthslar_i_herb=INITVAL;
 ubenthclar_i_herb=INITVAL;
 uherb_o_carn=INITVAL;
 uherb_i_carn=INITVAL;
 ubenthslar_i_carn=INITVAL;
 ubenthclar_i_carn=INITVAL;
 ubenthslar_o_carn=INITVAL;
 ubenthclar_o_carn=INITVAL;
 ufishplar_o_carn=INITVAL;
 ufishplar_i_carn=INITVAL;
 ufishdlar_o_carn=INITVAL;
 ufishdlar_i_carn=INITVAL;
 uherb_o_fishplar=INITVAL;
 uherb_i_fishplar=INITVAL;
 ubenthslar_i_fishplar=INITVAL;
 ubenthclar_i_fishplar=INITVAL;
 ubenthslar_o_fishplar=INITVAL;
 ubenthclar_o_fishplar=INITVAL;
 uherb_o_fishp=INITVAL;
 uherb_i_fishp=INITVAL;
 ucarn_o_fishp=INITVAL;
 ucarn_i_fishp=INITVAL;
 ubenthslar_i_fishp=INITVAL;
 ubenthclar_i_fishp=INITVAL;
 ubenthslar_o_fishp=INITVAL;
 ubenthclar_o_fishp=INITVAL;
 ufishdlar_o_fishp=INITVAL;
 ufishdlar_i_fishp=INITVAL;
 ufishplar_o_fishp=INITVAL;
 ufishplar_i_fishp=INITVAL;
 uherb_o_fishdlar=INITVAL;
 uherb_i_fishdlar=INITVAL;
 ubenthslar_i_fishdlar=INITVAL;
 ubenthclar_i_fishdlar=INITVAL;
 ubenthslar_o_fishdlar=INITVAL;
 ubenthclar_o_fishdlar=INITVAL;
 uherb_o_fishm=INITVAL;
 uherb_i_fishm=INITVAL;
 ucarn_o_fishm=INITVAL;
 ucarn_i_fishm=INITVAL;
 ubenthslar_i_fishm=INITVAL;
 ubenthclar_i_fishm=INITVAL;
 ubenthslar_o_fishm=INITVAL;
 ubenthclar_o_fishm=INITVAL;
 ufishdlar_o_fishm=INITVAL;
 ufishdlar_i_fishm=INITVAL;
 ufishplar_o_fishm=INITVAL;
 ufishplar_i_fishm=INITVAL;
 ucarn_o_fishd=INITVAL;
 ucarn_i_fishd=INITVAL;
 ubenths_i_fishd=INITVAL;
 ubenthc_i_fishd=INITVAL;
 ubenths_o_fishd=INITVAL;
 ubenthc_o_fishd=INITVAL;
 ufishplar_o_fishd=INITVAL;
 ufishplar_i_fishd=INITVAL;
 ufishdlar_o_fishd=INITVAL;
 ufishdlar_i_fishd=INITVAL;
 ufishp_o_fishd=INITVAL;
 ufishp_i_fishd=INITVAL;
 ufishm_o_fishd=INITVAL;
 ufishm_i_fishd=INITVAL;
 ufishd_o_fishd=INITVAL;
 ufishd_i_fishd=INITVAL;
 udisc_i_fishd=INITVAL;
 ucorp_i_fishd=INITVAL;
 udisc_o_fishd=INITVAL;
 ucorp_o_fishd=INITVAL;
 udet_so_benthslar=INITVAL;
 udet_d_benthslar=INITVAL;
 uphyt_so_benthslar=INITVAL;
 uphyt_d_benthslar=INITVAL;
 udet_si_benthslar=INITVAL;
 uphyt_si_benthslar=INITVAL;
 udet_so_benthclar=INITVAL;
 udet_d_benthclar=INITVAL;
 uphyt_so_benthclar=INITVAL;
 uphyt_d_benthclar=INITVAL;
 udet_si_benthclar=INITVAL;
 uphyt_si_benthclar=INITVAL;
 uphyt_si_benths_i=INITVAL;
 udet_si_benths_i=INITVAL;
 used_si_benths_i=INITVAL;
 uphyt_d_benths_o=INITVAL;
 udet_d_benths_o=INITVAL;
 used_d_benths_o=INITVAL;
 ubenths_i_benthc_i=INITVAL;
 ukelp_i_benthc_i=INITVAL;
 ukelpdebris_i_benthc_i=INITVAL;
 ucorp_i_benthc_i=INITVAL;
 ubenths_o_benthc_o=INITVAL;
 ucorp_o_benthc_o=INITVAL;
 ubenths_i_bird=INITVAL;
 ubenthc_i_bird=INITVAL;
 ubenths_o_bird=INITVAL;
 ubenthc_o_bird=INITVAL;
 udisc_i_bird=INITVAL;
 ucorp_i_bird=INITVAL;
 udisc_o_bird=INITVAL;
 ucorp_o_bird=INITVAL;
//  uherb_o_bird=INITVAL;
//  uherb_i_bird=INITVAL;
 ucarn_o_bird=INITVAL;
 ucarn_i_bird=INITVAL;
 ufishp_o_bird=INITVAL;
 ufishp_i_bird=INITVAL;
 ufishd_o_bird=INITVAL;
 ufishd_i_bird=INITVAL;
 ufishm_o_bird=INITVAL;
 ufishm_i_bird=INITVAL;
 ubenths_i_seal=INITVAL;
 ubenthc_i_seal=INITVAL;
 ubenths_o_seal=INITVAL;
 ubenthc_o_seal=INITVAL;
 udisc_i_seal=INITVAL;
 ucorp_i_seal=INITVAL;
 udisc_o_seal=INITVAL;
 ucorp_o_seal=INITVAL;
//   uherb_o_seal=INITVAL;
//   uherb_i_seal=INITVAL;
 ucarn_o_seal=INITVAL;
 ucarn_i_seal=INITVAL;
 ufishp_o_seal=INITVAL;
 ufishp_i_seal=INITVAL;
 ufishd_o_seal=INITVAL;
 ufishd_i_seal=INITVAL;
 ufishm_o_seal=INITVAL;
 ufishm_i_seal=INITVAL;
 ubird_o_seal=INITVAL;
 ubird_i_seal=INITVAL;
 ubenths_i_ceta=INITVAL;
 ubenths_o_ceta=INITVAL;
 ubenthc_i_ceta=INITVAL;
 ubenthc_o_ceta=INITVAL;
 udisc_i_ceta=INITVAL;
 udisc_o_ceta=INITVAL;
//   ucorp_i_ceta=INITVAL;
//   ucorp_o_ceta=INITVAL;
 uherb_o_ceta=INITVAL;
 uherb_i_ceta=INITVAL;
 ucarn_o_ceta=INITVAL;
 ucarn_i_ceta=INITVAL;
 ufishp_o_ceta=INITVAL;
 ufishp_i_ceta=INITVAL;
 ufishd_o_ceta=INITVAL;
 ufishd_i_ceta=INITVAL;
 ufishm_o_ceta=INITVAL;
 ufishm_i_ceta=INITVAL;
 ubird_o_ceta=INITVAL;
 ubird_i_ceta=INITVAL;
 useal_o_ceta=INITVAL;
 useal_i_ceta=INITVAL;
 eH_o=INITVAL;
 eH_i=INITVAL;
 eC_o=INITVAL;
 eC_i=INITVAL;
 ...
 corp_det_i=INITVAL;
 corp_det_o=INITVAL;
 kelpdebris_det_i=INITVAL;
 prop_herb_surfo=INITVAL;
 prop_herb_deep=INITVAL;
 prop_benthslar_surfo=INITVAL;
 prop_benthclar_surfo=INITVAL;
 prop_benthslar_deep=INITVAL;
 prop_benthclar_deep=INITVAL;
 prop_carn_surfo=INITVAL;
 prop_carn_deep=INITVAL;
 prop_fishplar_surfo=INITVAL;
 prop_fishplar_deep=INITVAL;
 prop_fishdlar_surfo=INITVAL;
 prop_fishdlar_deep=INITVAL;
 Upt_C_kelp_i=INITVAL;
 Upt_samm_kelp_i=INITVAL;
 Upt_snit_kelp_i=INITVAL;
 Upt_samm_sphyt_o=INITVAL;
 Upt_samm_sphyt_i=INITVAL;
 Upt_snit_sphyt_o=INITVAL;
 Upt_snit_sphyt_i=INITVAL;
 Upt_detritus_so_herb=INITVAL;
 Upt_detritus_si_herb=INITVAL;
 Upt_detritus_d_herb=INITVAL;
 Upt_phyt_so_herb=INITVAL;
 Upt_phyt_si_herb=INITVAL;
 Upt_phyt_d_herb=INITVAL;
 Upt_benthslar_o_herb=INITVAL;
 Upt_benthslar_i_herb=INITVAL;
 Upt_benthclar_o_herb=INITVAL;
 Upt_benthclar_i_herb=INITVAL;
 Upt_total_herb_o=INITVAL;
 Upt_total_herb_i=INITVAL;
 Upt_detritus_so_benthslar=INITVAL;
 Upt_detritus_d_benthslar=INITVAL;
 Upt_phyt_so_benthslar=INITVAL;
 Upt_phyt_d_benthslar=INITVAL;
 Upt_total_benthslar_o=INITVAL;
 Upt_detritus_so_benthclar=INITVAL;
 Upt_detritus_d_benthclar=INITVAL;
 Upt_phyt_so_benthclar=INITVAL;
 Upt_phyt_d_benthclar=INITVAL;
 Upt_total_benthclar_o=INITVAL;
 Upt_detritus_si_benthslar=INITVAL;
 Upt_phyt_si_benthslar=INITVAL;
 Upt_total_benthslar_i=INITVAL;
 Upt_detritus_si_benthclar=INITVAL;
 Upt_phyt_si_benthclar=INITVAL;
 Upt_total_benthclar_i=INITVAL;
 Upt_herb_o_carn=INITVAL;
 Upt_herb_i_carn=INITVAL;
 Upt_fishplar_o_carn=INITVAL;
 Upt_fishplar_i_carn=INITVAL;
 Upt_fishdlar_o_carn=INITVAL;
 Upt_fishdlar_i_carn=INITVAL;
 Upt_benthslar_o_carn=INITVAL;
 Upt_benthclar_o_carn=INITVAL;
 Upt_benthslar_i_carn=INITVAL;
 Upt_benthclar_i_carn=INITVAL;
 Upt_total_carn_o=INITVAL;
 Upt_total_carn_i=INITVAL;
 Upt_herb_o_fishplar=INITVAL;
 Upt_herb_i_fishplar=INITVAL;
 Upt_benthslar_o_fishplar=INITVAL;
 Upt_benthclar_o_fishplar=INITVAL;
 Upt_benthslar_i_fishplar=INITVAL;
 Upt_benthclar_i_fishplar=INITVAL;
 Upt_total_fishplar_o=INITVAL;
 Upt_total_fishplar_i=INITVAL;
 Upt_herb_o_fishdlar=INITVAL;
 Upt_herb_i_fishdlar=INITVAL;
 Upt_benthslar_o_fishdlar=INITVAL;
 Upt_benthclar_o_fishdlar=INITVAL;
 Upt_benthslar_i_fishdlar=INITVAL;
 Upt_benthclar_i_fishdlar=INITVAL;
 Upt_total_fishdlar_o=INITVAL;
 Upt_total_fishdlar_i=INITVAL;
 Upt_detritus_si_benths_i=INITVAL;
 Upt_phyt_si_benths_i=INITVAL;
 Upt_xTdetritus_s1_benths_i=INITVAL;
 Upt_xTdetritus_s2_benths_i=INITVAL;
 Upt_xTdetritus_s3_benths_i=INITVAL;
 Upt_xdetritus_s1_benths_i=INITVAL;
 Upt_xdetritus_s2_benths_i=INITVAL;
 Upt_xdetritus_s3_benths_i=INITVAL;
 Upt_xRdetritus_s1_benths_i=INITVAL;
 Upt_xRdetritus_s2_benths_i=INITVAL;
 Upt_xRdetritus_s3_benths_i=INITVAL;
 Upt_total_benths_i=INITVAL;
 Upt_total_benths_s0=INITVAL;
 Upt_total_benths_s1=INITVAL;
 Upt_total_benths_s2=INITVAL;
 Upt_total_benths_s3=INITVAL;
 Upt_detritus_d_benths_o=INITVAL;
 Upt_phyt_d_benths_o=INITVAL;
 Upt_xTdetritus_d1_benths_o=INITVAL;
 Upt_xTdetritus_d2_benths_o=INITVAL;
 Upt_xTdetritus_d3_benths_o=INITVAL;
 Upt_xdetritus_d1_benths_o=INITVAL;
 Upt_xdetritus_d2_benths_o=INITVAL;
 Upt_xdetritus_d3_benths_o=INITVAL;
 Upt_xRdetritus_d1_benths_o=INITVAL;
 Upt_xRdetritus_d2_benths_o=INITVAL;
 Upt_xRdetritus_d3_benths_o=INITVAL;
 Upt_total_benths_o=INITVAL;
 Upt_total_benths_d0=INITVAL;
 Upt_total_benths_d1=INITVAL;
 Upt_total_benths_d2=INITVAL;
 Upt_total_benths_d3=INITVAL;
 Upt_benths_i_benthc_i=INITVAL;
 Upt_kelp_s0_benthc_i=INITVAL;
 Upt_kelpdebris_s0_benthc_i=INITVAL;
 Upt_corpse_s0_benthc_i=INITVAL;
 Upt_corpse_s1_benthc_i=INITVAL;
 Upt_corpse_s2_benthc_i=INITVAL;
 Upt_corpse_s3_benthc_i=INITVAL;
 Upt_total_benthc_s0=INITVAL;
 Upt_total_benthc_s1=INITVAL;
 Upt_total_benthc_s2=INITVAL;
 Upt_total_benthc_s3=INITVAL;
 Upt_total_benthc_i=INITVAL;
 Upt_benths_o_benthc_o=INITVAL;
 Upt_corpse_d0_benthc_o=INITVAL;
 Upt_corpse_d1_benthc_o=INITVAL;
 Upt_corpse_d2_benthc_o=INITVAL;
 Upt_corpse_d3_benthc_o=INITVAL;
 Upt_total_benthc_d0=INITVAL;
 Upt_total_benthc_d1=INITVAL;
 Upt_total_benthc_d2=INITVAL;
 Upt_total_benthc_d3=INITVAL;
 Upt_total_benthc_o=INITVAL;
 Upt_herb_o_fishp=INITVAL;
 Upt_herb_i_fishp=INITVAL;
 Upt_carn_o_fishp=INITVAL;
 Upt_carn_i_fishp=INITVAL;
 Upt_benthslar_o_fishp=INITVAL;
 Upt_benthclar_o_fishp=INITVAL;
 Upt_benthslar_i_fishp=INITVAL;
 Upt_benthclar_i_fishp=INITVAL;
 Upt_fishplar_o_fishp=INITVAL;
 Upt_fishplar_i_fishp=INITVAL;
 Upt_fishdlar_o_fishp=INITVAL;
 Upt_fishdlar_i_fishp=INITVAL;
 Upt_total_fishp_o =INITVAL;
 Upt_total_fishp_i =INITVAL;
 Upt_herb_o_fishm=INITVAL;
 Upt_herb_i_fishm=INITVAL;
 Upt_carn_o_fishm=INITVAL;
 Upt_carn_i_fishm=INITVAL;
 Upt_benthslar_o_fishm=INITVAL;
 Upt_benthclar_o_fishm=INITVAL;
 Upt_benthslar_i_fishm=INITVAL;
 Upt_benthclar_i_fishm=INITVAL;
 Upt_fishplar_o_fishm=INITVAL;
 Upt_fishplar_i_fishm=INITVAL;
 Upt_fishdlar_o_fishm=INITVAL;
 Upt_fishdlar_i_fishm=INITVAL;
 Upt_total_fishm_o =INITVAL;
 Upt_total_fishm_i =INITVAL;
 Upt_corpse_s0_fishd=INITVAL;
 Upt_corpse_s1_fishd=INITVAL;
 Upt_corpse_s2_fishd=INITVAL;
 Upt_corpse_s3_fishd=INITVAL;
 Upt_corpse_d0_fishd=INITVAL;
 Upt_corpse_d1_fishd=INITVAL;
 Upt_corpse_d2_fishd=INITVAL;
 Upt_corpse_d3_fishd=INITVAL;
 Upt_corpse_o_fishd=INITVAL;
 Upt_corpse_i_fishd=INITVAL;
 Upt_disc_o_fishd=INITVAL;
 Upt_disc_i_fishd=INITVAL;
 Upt_carn_o_fishd=INITVAL;
 Upt_carn_i_fishd=INITVAL;
 Upt_benths_o_fishd=INITVAL;
 Upt_benths_i_fishd=INITVAL;
 Upt_benthc_o_fishd=INITVAL;
 Upt_benthc_i_fishd=INITVAL;
 Upt_fishplar_o_fishd=INITVAL;
 Upt_fishplar_i_fishd=INITVAL;
 Upt_fishdlar_o_fishd=INITVAL;
 Upt_fishdlar_i_fishd=INITVAL;
 Upt_fishp_o_fishd=INITVAL;
 Upt_fishp_i_fishd=INITVAL;
 Upt_fishm_o_fishd=INITVAL;
 Upt_fishm_i_fishd=INITVAL;
 Upt_fishd_o_fishd=INITVAL;
 Upt_fishd_i_fishd=INITVAL;
 Upt_total_fishd_o=INITVAL;
 Upt_total_fishd_i=INITVAL;
 Upt_corpse_s0_bird=INITVAL;
 Upt_corpse_s1_bird=INITVAL;
 Upt_corpse_s2_bird=INITVAL;
 Upt_corpse_s3_bird=INITVAL;
 Upt_corpse_d0_bird=INITVAL;
 Upt_corpse_d1_bird=INITVAL;
 Upt_corpse_d2_bird=INITVAL;
 Upt_corpse_d3_bird=INITVAL;
 Upt_corpse_i_bird=INITVAL;
 Upt_corpse_o_bird=INITVAL;
//   Upt_herb_o_bird=INITVAL;
//   Upt_herb_i_bird=INITVAL;
 Upt_carn_o_bird=INITVAL;
 Upt_carn_i_bird=INITVAL;
 Upt_benths_o_bird=INITVAL;
 Upt_benths_i_bird=INITVAL;
 Upt_benthc_o_bird=INITVAL;
 Upt_benthc_i_bird=INITVAL;
 Upt_disc_o_bird=INITVAL;
 Upt_disc_i_bird=INITVAL;
 Upt_fishp_o_bird=INITVAL;
 Upt_fishp_i_bird=INITVAL;
 Upt_fishm_o_bird=INITVAL;
 Upt_fishm_i_bird=INITVAL;
 Upt_fishd_o_bird=INITVAL;
 Upt_fishd_i_bird=INITVAL;
 Upt_total_bird_o=INITVAL;
 Upt_total_bird_i=INITVAL;
 Upt_corpse_s0_seal=INITVAL;
 Upt_corpse_s1_seal=INITVAL;
 Upt_corpse_s2_seal=INITVAL;
 Upt_corpse_s3_seal=INITVAL;
 Upt_corpse_d0_seal=INITVAL;
 Upt_corpse_d1_seal=INITVAL;
 Upt_corpse_d2_seal=INITVAL;
 Upt_corpse_d3_seal=INITVAL;
 Upt_corpse_i_seal=INITVAL;
 Upt_corpse_o_seal=INITVAL;
//   Upt_herb_o_seal=INITVAL;
//   Upt_herb_i_seal=INITVAL;
 Upt_carn_o_seal=INITVAL;
 Upt_carn_i_seal=INITVAL;
 Upt_benths_o_seal=INITVAL;
 Upt_benths_i_seal=INITVAL;
 Upt_benthc_o_seal=INITVAL;
 Upt_benthc_i_seal=INITVAL;
 Upt_disc_o_seal=INITVAL;
 Upt_disc_i_seal=INITVAL;
 Upt_fishp_o_seal=INITVAL;
 Upt_fishp_i_seal=INITVAL;
 Upt_fishm_o_seal=INITVAL;
 Upt_fishm_i_seal=INITVAL;
 Upt_fishd_o_seal=INITVAL;
 Upt_fishd_i_seal=INITVAL;
 Upt_bird_o_seal=INITVAL;
 Upt_bird_i_seal=INITVAL;
 Upt_total_seal_o=INITVAL;
 Upt_total_seal_i=INITVAL;
//   Upt_corpse_s1_ceta=INITVAL;
//   Upt_corpse_s2_ceta=INITVAL;
//   Upt_corpse_s3_ceta=INITVAL;
//   Upt_corpse_d1_ceta=INITVAL;
//   Upt_corpse_d2_ceta=INITVAL;
//   Upt_corpse_d3_ceta=INITVAL;
//   Upt_corpse_i_ceta=INITVAL;
//   Upt_corpse_o_ceta=INITVAL;
 Upt_herb_o_ceta=INITVAL;
 Upt_herb_i_ceta=INITVAL;
 Upt_carn_o_ceta=INITVAL;
 Upt_carn_i_ceta=INITVAL;
 Upt_benths_o_ceta=INITVAL;
 Upt_benths_i_ceta=INITVAL;
 Upt_benthc_o_ceta=INITVAL;
 Upt_benthc_i_ceta=INITVAL;
 Upt_disc_o_ceta=INITVAL;
 Upt_disc_i_ceta=INITVAL;
 Upt_fishp_o_ceta=INITVAL;
 Upt_fishp_i_ceta=INITVAL;
 Upt_fishm_o_ceta=INITVAL;
 Upt_fishm_i_ceta=INITVAL;
 Upt_fishd_o_ceta=INITVAL;
 Upt_fishd_i_ceta=INITVAL;
 Upt_bird_o_ceta=INITVAL;
 Upt_bird_i_ceta=INITVAL;
 Upt_seal_o_ceta=INITVAL;
 Upt_seal_i_ceta=INITVAL;
 Upt_total_ceta_o=INITVAL;
 Upt_total_ceta_i=INITVAL;
 Exude_kelp_i=INITVAL;
 Excr_herb_so=INITVAL;
 Excr_herb_si=INITVAL;
 Excr_herb_d=INITVAL;
 Excr_carn_so=INITVAL;
 Excr_carn_si=INITVAL;
 Excr_carn_d=INITVAL;
 Excr_benthslar_so=INITVAL;
 Excr_benthslar_si=INITVAL;
 Excr_benthslar_d=INITVAL;
 Excr_benthclar_so=INITVAL;
 Excr_benthclar_si=INITVAL;
 Excr_benthclar_d=INITVAL;
 Excr_benths_i=INITVAL;
 Excr_benths_s0=INITVAL;
 Excr_benths_s1=INITVAL;
 Excr_benths_s2=INITVAL;
 Excr_benths_s3=INITVAL;
 Excr_benthc_i=INITVAL;
 Excr_benthc_s0=INITVAL;
 Excr_benthc_s1=INITVAL;
 Excr_benthc_s2=INITVAL;
 Excr_benthc_s3=INITVAL;
 Excr_benths_o=INITVAL;
 Excr_benths_d0=INITVAL;
 Excr_benths_d1=INITVAL;
 Excr_benths_d2=INITVAL;
 Excr_benths_d3=INITVAL;
 Excr_benthc_o=INITVAL;
 Excr_benthc_d0=INITVAL;
 Excr_benthc_d1=INITVAL;
 Excr_benthc_d2=INITVAL;
 Excr_benthc_d3=INITVAL;
 Excr_fishplar_so=INITVAL;
 Excr_fishplar_si=INITVAL;
 Excr_fishplar_d=INITVAL;
 Excr_fishdlar_so=INITVAL;
 Excr_fishdlar_si=INITVAL;
 Excr_fishdlar_d=INITVAL;
 Excr_fishp_so=INITVAL;
 Excr_fishp_si=INITVAL;
 Excr_fishp_d=INITVAL;
 Excr_fishm_so=INITVAL;
 Excr_fishm_si=INITVAL;
 Excr_fishm_d=INITVAL;
 Excr_fishd_so=INITVAL;
 Excr_fishd_si=INITVAL;
 Excr_fishd_d=INITVAL;
 Excr_bird_so=INITVAL;
 Excr_bird_si=INITVAL;
 Excr_bird_d=INITVAL;
 Excr_seal_so=INITVAL;
 Excr_seal_si=INITVAL;
 Excr_seal_d=INITVAL;
 Excr_ceta_so=INITVAL;
 Excr_ceta_si=INITVAL;
 Excr_ceta_d=INITVAL;
 Defec_herb_so=INITVAL;
 Defec_herb_si=INITVAL;
 Defec_herb_d=INITVAL;
 Defec_carn_so=INITVAL;
 Defec_carn_si=INITVAL;
 Defec_carn_d=INITVAL;
 Defec_benthslar_so=INITVAL;
 Defec_benthslar_si=INITVAL;
 Defec_benthslar_d=INITVAL;
 Defec_benthclar_so=INITVAL;
 Defec_benthclar_si=INITVAL;
 Defec_benthclar_d=INITVAL;
 Defec_benths_i=INITVAL;
 Defec_benths_s0=INITVAL;
 Defec_benths_s1=INITVAL;
 Defec_benths_s2=INITVAL;
 Defec_benths_s3=INITVAL;
 Defec_benths_o=INITVAL;
 Defec_benths_d0=INITVAL;
 Defec_benths_d1=INITVAL;
 Defec_benths_d2=INITVAL;
 Defec_benths_d3=INITVAL;
 Defec_benthc_i=INITVAL;
 Defec_benthc_s0=INITVAL;
 Defec_benthc_s1=INITVAL;
 Defec_benthc_s2=INITVAL;
 Defec_benthc_s3=INITVAL;
 Defec_benthc_o=INITVAL;
 Defec_benthc_d0=INITVAL;
 Defec_benthc_d1=INITVAL;
 Defec_benthc_d2=INITVAL;
 Defec_benthc_d3=INITVAL;
 Defec_fishplar_so=INITVAL;
 Defec_fishplar_si=INITVAL;
 Defec_fishplar_d=INITVAL;
 Defec_fishdlar_so=INITVAL;
 Defec_fishdlar_si=INITVAL;
 Defec_fishdlar_d=INITVAL;
 Defec_fishp_so=INITVAL;
 Defec_fishp_si=INITVAL;
 Defec_fishp_d=INITVAL;
 Defec_fishm_so=INITVAL;
 Defec_fishm_si=INITVAL;
 Defec_fishm_d=INITVAL;
 Defec_fishd_so=INITVAL;
 Defec_fishd_si=INITVAL;
 Defec_fishd_d=INITVAL;
 Defec_bird_so=INITVAL;
 Defec_bird_si=INITVAL;
 Defec_bird_d=INITVAL;
 Defec_seal_so=INITVAL;
 Defec_seal_si=INITVAL;
 Defec_seal_d=INITVAL;
 Defec_ceta_so=INITVAL;
 Defec_ceta_si=INITVAL;
 Defec_ceta_d=INITVAL;
 Assim_herb_o=INITVAL;
 Assim_herb_i=INITVAL;
 Assim_carn_o=INITVAL;
 Assim_carn_i=INITVAL;
 Assim_benthslar_o=INITVAL;
 Assim_benthslar_i=INITVAL;
 Assim_benthclar_o=INITVAL;
 Assim_benthclar_i=INITVAL;
 Assim_benths_o=INITVAL;
 Assim_benths_i=INITVAL;
 Assim_benthc_o=INITVAL;
 Assim_benthc_i=INITVAL;
 Assim_fishplar_o=INITVAL;
 Assim_fishplar_i=INITVAL;
 Assim_fishp_o=INITVAL;
 Assim_fishp_i=INITVAL;
 Assim_fishm_o=INITVAL;
 Assim_fishm_i=INITVAL;
 Assim_fishdlar_o=INITVAL;
 Assim_fishdlar_i=INITVAL;
 Assim_fishd_o=INITVAL;
 Assim_fishd_i=INITVAL;
 Assim_bird_o=INITVAL;
 Assim_bird_i=INITVAL;
 Assim_seal_o=INITVAL;
 Assim_seal_i=INITVAL;
 Assim_ceta_o=INITVAL;
 Assim_ceta_i=INITVAL;
 Vmix_detritus=INITVAL;
 Vmix_ammonia=INITVAL;
 Vmix_nitrate=INITVAL;
 Vmix_phyt=INITVAL;
 detr_settle_s_b=INITVAL;
 detr_settle_s_d=INITVAL;
 detr_settle_d=INITVAL;
 bioturb_daily_s1=INITVAL;
 bioturb_daily_s2=INITVAL;
 bioturb_daily_s3=INITVAL;
 bioturb_daily_d1=INITVAL;
 bioturb_daily_d2=INITVAL;
 bioturb_daily_d3=INITVAL;
 porewater_disturb_s1=INITVAL;
 porewater_disturb_s2=INITVAL;
 porewater_disturb_s3=INITVAL;
 porewater_disturb_d1=INITVAL;
 porewater_disturb_d2=INITVAL;
 porewater_disturb_d3=INITVAL;
 sediment_resuspend_s1=INITVAL;
 sediment_resuspend_s2=INITVAL;
 sediment_resuspend_s3=INITVAL;
 sediment_resuspend_d1=INITVAL;
 sediment_resuspend_d2=INITVAL;
 sediment_resuspend_d3=INITVAL;
 s_w_amm_flx_s1=INITVAL;
 s_w_amm_flx_s2=INITVAL;
 s_w_amm_flx_s3=INITVAL;
 s_w_nit_flx_s1=INITVAL;
 s_w_nit_flx_s2=INITVAL;
 s_w_nit_flx_s3=INITVAL;
 s_w_amm_flx_d1=INITVAL;
 s_w_amm_flx_d2=INITVAL;
 s_w_amm_flx_d3=INITVAL;
 s_w_nit_flx_d1=INITVAL;
 s_w_nit_flx_d2=INITVAL;
 s_w_nit_flx_d3=INITVAL;
 s_w_amm_disturb_flx_s1=INITVAL;
 s_w_amm_disturb_flx_s2=INITVAL;
 s_w_amm_disturb_flx_s3=INITVAL;
 s_w_nit_disturb_flx_s1=INITVAL;
 s_w_nit_disturb_flx_s2=INITVAL;
 s_w_nit_disturb_flx_s3=INITVAL;
 s_w_amm_disturb_flx_d1=INITVAL;
 s_w_amm_disturb_flx_d2=INITVAL;
 s_w_amm_disturb_flx_d3=INITVAL;
 s_w_nit_disturb_flx_d1=INITVAL;
 s_w_nit_disturb_flx_d2=INITVAL;
 s_w_nit_disturb_flx_d3=INITVAL;
 s_w_det_resuspend_flx_s1=INITVAL;
 s_w_det_resuspend_flx_s2=INITVAL;
 s_w_det_resuspend_flx_s3=INITVAL;
 s_w_det_resuspend_flx_d1=INITVAL;
 s_w_det_resuspend_flx_d2=INITVAL;
 s_w_det_resuspend_flx_d3=INITVAL;
 p_disc_s0=INITVAL;
 p_disc_s1=INITVAL;
 p_disc_s2=INITVAL;
 p_disc_s3=INITVAL;
 ...
 p_disc_d2=INITVAL;
 p_disc_d3=INITVAL;
 OceanIN_sodetritus=INITVAL;
 OceanIN_soammonia=INITVAL;
 OceanIN_sonitrate=INITVAL;
 OceanIN_sophyt=INITVAL;
 OceanIN_ddetritus=INITVAL;
 OceanIN_dammonia=INITVAL;
 OceanIN_dnitrate=INITVAL;
 OceanIN_dphyt=INITVAL;
 OceanIN_sidetritus=INITVAL;
 OceanIN_siammonia=INITVAL;
 OceanIN_sinitrate=INITVAL;
 OceanIN_siphyt=INITVAL;
 OceanOUT_sodetritus=INITVAL;
 OceanOUT_soammonia=INITVAL;
 OceanOUT_sonitrate=INITVAL;
 OceanOUT_sophyt=INITVAL;
 OceanOUT_ddetritus=INITVAL;
 OceanOUT_dammonia=INITVAL;
 OceanOUT_dnitrate=INITVAL;
 OceanOUT_dphyt=INITVAL;
 OceanOUT_sidetritus=INITVAL;
 OceanOUT_siammonia=INITVAL;
 OceanOUT_sinitrate=INITVAL;
 OceanOUT_siphyt=INITVAL;
 InshoreIN_sdetritus=INITVAL;
 InshoreIN_sammonia=INITVAL;
 InshoreIN_snitrate=INITVAL;
 InshoreIN_sphyt=INITVAL;
 InshoreIN_benthslar=INITVAL;
 InshoreIN_benthclar=INITVAL;
 InshoreIN_herb=INITVAL;
 InshoreIN_carn=INITVAL;
 InshoreIN_fishplar=INITVAL;
 InshoreIN_fishdlar=INITVAL;
 InshoreIN_fishp=INITVAL;
 InshoreIN_fishd=INITVAL;
 InshoreIN_fishm=INITVAL;
 InshoreIN_bird=INITVAL;
 InshoreIN_seal=INITVAL;
 InshoreIN_ceta=INITVAL;
 InshoreOUT_sdetritus=INITVAL;
 InshoreOUT_sammonia=INITVAL;
 InshoreOUT_snitrate=INITVAL;
 InshoreOUT_sphyt=INITVAL;
 InshoreOUT_benthslar=INITVAL;
 InshoreOUT_benthclar=INITVAL;
 InshoreOUT_herb=INITVAL;
 InshoreOUT_carn=INITVAL;
 InshoreOUT_fishplar=INITVAL;
 InshoreOUT_fishdlar=INITVAL;
 InshoreOUT_fishp=INITVAL;
 InshoreOUT_fishd=INITVAL;
 InshoreOUT_fishm=INITVAL;
 InshoreOUT_bird=INITVAL;
 InshoreOUT_seal=INITVAL;
 InshoreOUT_ceta=INITVAL;
 Upwelling_det=INITVAL;
 Upwelling_amm=INITVAL;
 Upwelling_nit=INITVAL;
 Upwelling_phyt=INITVAL;
 Riv_amm_IN=INITVAL;
 Riv_nit_IN=INITVAL;
 Riv_det_IN=INITVAL;
 Atm_amm_IN_o=INITVAL;
 Atm_nit_IN_o=INITVAL;
 Atm_amm_IN_i=INITVAL;
 Atm_nit_IN_i=INITVAL;
 Flx_pfish_disc_s0=INITVAL;
 Flx_pfish_disc_s1=INITVAL;
 Flx_pfish_disc_s2=INITVAL;
 Flx_pfish_disc_s3=INITVAL;
 Flx_pfish_disc_d0=INITVAL;
 Flx_pfish_disc_d1=INITVAL;
 Flx_pfish_disc_d2=INITVAL;
 Flx_pfish_disc_d3=INITVAL;
 Flx_dfish_disc_s0=INITVAL;
 Flx_dfish_disc_s1=INITVAL;
 Flx_dfish_disc_s2=INITVAL;
 Flx_dfish_disc_s3=INITVAL;
 Flx_dfish_disc_d0=INITVAL;
 Flx_dfish_disc_d1=INITVAL;
 Flx_dfish_disc_d2=INITVAL;
 Flx_dfish_disc_d3=INITVAL;
 Flx_sbfish_disc_s0=INITVAL;
 Flx_sbfish_disc_s1=INITVAL;
 Flx_sbfish_disc_s2=INITVAL;
 Flx_sbfish_disc_s3=INITVAL;
 Flx_sbfish_disc_d0=INITVAL;
 Flx_sbfish_disc_d1=INITVAL;
 Flx_sbfish_disc_d2=INITVAL;
 Flx_sbfish_disc_d3=INITVAL;
 Flx_cbfish_disc_s0=INITVAL;
 Flx_cbfish_disc_s1=INITVAL;
 Flx_cbfish_disc_s2=INITVAL;
 Flx_cbfish_disc_s3=INITVAL;
 Flx_cbfish_disc_d0=INITVAL;
 Flx_cbfish_disc_d1=INITVAL;
 Flx_cbfish_disc_d2=INITVAL;
 Flx_cbfish_disc_d3=INITVAL;
 Flx_czfish_disc_s0=INITVAL;
 Flx_czfish_disc_s1=INITVAL;
 Flx_czfish_disc_s2=INITVAL;
 Flx_czfish_disc_s3=INITVAL;
 Flx_czfish_disc_d0=INITVAL;
 Flx_czfish_disc_d1=INITVAL;
 Flx_czfish_disc_d2=INITVAL;
 Flx_czfish_disc_d3=INITVAL;
 Flx_mfish_disc_s0=INITVAL;
 Flx_mfish_disc_s1=INITVAL;
 Flx_mfish_disc_s2=INITVAL;
 Flx_mfish_disc_s3=INITVAL;
 Flx_mfish_disc_d0=INITVAL;
 Flx_mfish_disc_d1=INITVAL;
 Flx_mfish_disc_d2=INITVAL;
 Flx_mfish_disc_d3=INITVAL;
 Flx_tot_disc_i=INITVAL;
 Flx_tot_disc_o=INITVAL;
 Flx_pfish_offal_s0=INITVAL;
 Flx_pfish_offal_s1=INITVAL;
 Flx_pfish_offal_s2=INITVAL;
 Flx_pfish_offal_s3=INITVAL;
 Flx_pfish_offal_d0=INITVAL;
 Flx_pfish_offal_d1=INITVAL;
 Flx_pfish_offal_d2=INITVAL;
 Flx_pfish_offal_d3=INITVAL;
 Flx_dfish_offal_s0=INITVAL;
 Flx_dfish_offal_s1=INITVAL;
 Flx_dfish_offal_s2=INITVAL;
 Flx_dfish_offal_s3=INITVAL;
 Flx_dfish_offal_d0=INITVAL;
 Flx_dfish_offal_d1=INITVAL;
 Flx_dfish_offal_d2=INITVAL;
 Flx_dfish_offal_d3=INITVAL;
 Flx_sbfish_offal_s0=INITVAL;
 Flx_sbfish_offal_s1=INITVAL;
 Flx_sbfish_offal_s2=INITVAL;
 Flx_sbfish_offal_s3=INITVAL;
 Flx_sbfish_offal_d0=INITVAL;
 Flx_sbfish_offal_d1=INITVAL;
 Flx_sbfish_offal_d2=INITVAL;
 Flx_sbfish_offal_d3=INITVAL;
 Flx_cbfish_offal_s0=INITVAL;
 Flx_cbfish_offal_s1=INITVAL;
 Flx_cbfish_offal_s2=INITVAL;
 Flx_cbfish_offal_s3=INITVAL;
 Flx_cbfish_offal_d0=INITVAL;
 Flx_cbfish_offal_d1=INITVAL;
 Flx_cbfish_offal_d2=INITVAL;
 Flx_cbfish_offal_d3=INITVAL;
 Flx_czfish_offal_s0=INITVAL;
 Flx_czfish_offal_s1=INITVAL;
 Flx_czfish_offal_s2=INITVAL;
 Flx_czfish_offal_s3=INITVAL;
 Flx_czfish_offal_d0=INITVAL;
 Flx_czfish_offal_d1=INITVAL;
 Flx_czfish_offal_d2=INITVAL;
 Flx_czfish_offal_d3=INITVAL;
 Flx_mfish_offal_s0=INITVAL;
 Flx_mfish_offal_s1=INITVAL;
 Flx_mfish_offal_s2=INITVAL;
 Flx_mfish_offal_s3=INITVAL;
 Flx_mfish_offal_d0=INITVAL;
 Flx_mfish_offal_d1=INITVAL;
 Flx_mfish_offal_d2=INITVAL;
 Flx_mfish_offal_d3=INITVAL;
 Flx_bird_offal_s0=INITVAL;
 Flx_bird_offal_s1=INITVAL;
 Flx_bird_offal_s2=INITVAL;
 Flx_bird_offal_s3=INITVAL;
 Flx_bird_offal_d0=INITVAL;
 Flx_bird_offal_d1=INITVAL;
 Flx_bird_offal_d2=INITVAL;
 Flx_bird_offal_d3=INITVAL;
 Flx_seal_offal_s0=INITVAL;
 Flx_seal_offal_s1=INITVAL;
 Flx_seal_offal_s2=INITVAL;
 Flx_seal_offal_s3=INITVAL;
 Flx_seal_offal_d0=INITVAL;
 Flx_seal_offal_d1=INITVAL;
 Flx_seal_offal_d2=INITVAL;
 Flx_seal_offal_d3=INITVAL;
 Flx_ceta_offal_s0=INITVAL;
 Flx_ceta_offal_s1=INITVAL;
 Flx_ceta_offal_s2=INITVAL;
 Flx_ceta_offal_s3=INITVAL;
 Flx_ceta_offal_d0=INITVAL;
 Flx_ceta_offal_d1=INITVAL;
 Flx_ceta_offal_d2=INITVAL;
 Flx_ceta_offal_d3=INITVAL;
 Flx_tot_offal_i=INITVAL;
 Flx_tot_offal_o=INITVAL;
 jan_fishd_o=INITVAL;
 jan_fishd_i=INITVAL;
 jan_fishd=INITVAL;
 Ddiscard=INITVAL;
 ...
 Dodiscard=INITVAL;
 DFp_NQ=INITVAL;
 DFp_undersizeNQ=INITVAL;
 DFp_undersizeQ=INITVAL;
 DFp_discardNQ=INITVAL;
 DFip_discardNQ=INITVAL;
 DFop_discardNQ=INITVAL;
 DFp_discardQ=INITVAL;
 DFip_discardQ=INITVAL;
 DFop_discardQ=INITVAL;
 D_i_weighting=INITVAL;
 D_o_weighting=INITVAL;
 DFp_undersizeALL=INITVAL;
 Fdidaily_USC=INITVAL;
 Fdodaily_USC=INITVAL;
 food_gradient_pfish=INITVAL;
 food_gradient_mfish=INITVAL;
 food_gradient_dfish=INITVAL;
 food_gradient_bird=INITVAL;
 food_gradient_seal=INITVAL;
 food_gradient_ceta=INITVAL;
 HTLmetabolism_so=INITVAL;
 HTLmetabolism_d=INITVAL;
 HTLmetabolism_so_d=INITVAL;
 HTLmetabolism_si=INITVAL;
 s1_stick_reflect=INITVAL;
 s2_stick_reflect=INITVAL;
 s3_stick_reflect=INITVAL;
 d1_stick_reflect=INITVAL;
 d2_stick_reflect=INITVAL;
 d3_stick_reflect=INITVAL;
 kelp_i_slope=INITVAL;
 kelp_i_int=INITVAL;
 kelp_Ucsc=INITVAL;
 kelp_Unsc=INITVAL;
 CZ_edible_o=INITVAL;
